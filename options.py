...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--results', type=str, default="datasets/results", help='save test results to this path.')
        parser.add_argument('--interpolate_len', type=int, default=1, help='interpolate length for test.')
...
#        parser.add_argument('--save_test_gif', type=bool,default=True, help='save gif images instead of the concatenation of static images.')# generate gif, remember to modify interpolate_len

        parser.add_argument('--data_root', type=str, default="datasets/test", help='paths to data set.')
        ...
        parser.add_argument('--ckpt_dir', type=str, default='./ckpts/190327_160828', help='directory to save check points.')
